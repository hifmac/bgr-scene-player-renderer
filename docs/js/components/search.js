...
export default function Search(id, config) {
    this.adelite = new Adelite(id, template);
    this.config = config;
}

/** @type {Adelite} */
Search.prototype.adelite = null;
...
Search.prototype.tables = [];

Search.prototype.show = function Search_show() {
...
Search.prototype.submit = function Search_submit(searchType, searchText) {
    this.tables = [];
    this.adelite.update();
